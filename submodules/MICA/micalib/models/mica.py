...
from submodules.MICA.models.arcface import Arcface
from submodules.MICA.models.generator import Generator
from submodules.MICA.micalib.base_model import BaseModel
...
class MICA(BaseModel):
    ...
    def load_model(self):
        ...
        if os.path.exists(model_path):
            ...
            print(f'ERROR: Checkpoint not available starting from scratch!')
