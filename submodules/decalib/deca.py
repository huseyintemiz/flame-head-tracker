...
import cv2
import pickle
from .deca_utils.renderer import SRenderY, set_rasterizer
from .models.encoders import ResnetEncoder
from .models.FLAME import FLAME, FLAMETex
from .models.decoders import Generator
from .deca_utils import util
from .deca_utils.rotation_converter import batch_euler2axis
from .deca_utils.tensor_cropper import transform_points
from .deca_utils.config import cfg
torch.backends.cudnn.benchmark = True
from .deca_utils.detectors import FAN
...
class DECA(nn.Module):
    ...
    def load_and_crop_image(self, imagepath):
        ## Modified by Peizhi
        ## input:
        ##    -imagepath: string
        ## return:
        ##    -img_tensor: [3,224,224]  tensor
